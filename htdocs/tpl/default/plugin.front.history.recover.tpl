...
<table width="95%" bgcolor="{%COLOR_TUBORG_CONTENT%}" class="window"
      ...
      <table width="100%" cellpadding="5" cellspacing="0" border="0">
        ...
        <tr>
          <td width="100%">
            ...
            <div class="areaoverflow" style="height:{%EDIT_HIST_AREA_HEIGHT%}px; width: {%EDIT_HIST_AREA_WIDTH%}px;">
              <table width="100%">
                <tr>
                  <td>
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td nowrap class="monospace" align="right">&nbsp;{%I18N_NAME%}:&nbsp;</td>
                        <td class="monospace" width="100%">{%TPL_ITEM_HIST_NAME%}</td>
                      </tr>
                      <tr>
