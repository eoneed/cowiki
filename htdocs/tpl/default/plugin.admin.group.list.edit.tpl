            ...
            <div class="areaoverflow" style="height:{%EDIT_DIR_AREA_HEIGHT%}px;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr valign="top">
                  ...
                  <td>&nbsp;&nbsp;</td>
                  <td nowrap width="100%">{%I18N_DESCRIPTION%}</td>
                </tr>

                <tr>
                  <td colspan="3"><img src="{%PATH_IMAGES%}0.gif"
                ...
                {foreach %TPL_ITEM%}
                  <tr bgcolor="{%COLOR_BGCOLOR%}" onmouseover="mover(this)"
                    ...
                    <td class="monospace" nowrap><a
                      href="{%TPL_ITEM['HREF']%}">{%TPL_ITEM['NAME']%}</a></td>
                    <td>&nbsp;</td>
                    <td>{%TPL_ITEM['DESC']%}</td>
                  </tr>
                {/foreach}
